...
<div class="content">
    ...
    <div class="card mt-2">
        ...
        <div class="row" onload="tabalerefresh()">
        <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/md/branch" class="btn btn-primary" target="_blank">
                    <i class="fa fa-plus">&nbsp;Create New</i>
                </a>
            </div>
            <div class="col-md-12">
            <table class="table datatable-fixed-both table-striped" id="branchTable">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>Name</th>
