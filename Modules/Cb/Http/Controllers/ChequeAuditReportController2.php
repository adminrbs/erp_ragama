...
class ChequeAuditReportController2 extends Controller
{
...

    {
        ...
        (SELECT customer_receipt_setoff_data.paid_amount  FROM customer_receipt_setoff_data WHERE customer_receipt_setoff_data.reference_external_number = debtors_ledgers.external_number GROUP BY debtors_ledgers.external_number),
