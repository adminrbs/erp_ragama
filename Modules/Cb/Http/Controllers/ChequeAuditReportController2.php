...
class ChequeAuditReportController2 extends Controller
{
...

    {
        ...
        (SELECT customer_receipt_setoff_data.paid_amount  FROM customer_receipt_setoff_data WHERE customer_receipt_setoff_data.external_number = customer_receipts.external_number LIMIT 1),
