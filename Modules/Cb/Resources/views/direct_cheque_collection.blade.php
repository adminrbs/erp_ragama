    ...
    <div class="card mt-2">
        <div class="card">
            <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Direct Cheque Collection</h5>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table datatable-fixed-both table-striped" id="cheque_collection_by_ho_table" style="table-layout:fixed">
                        <thead>
                            <tr>
            ...
            <div class="col-md-4" style="margin-left: 10px;margin-bottom:5px;float:right;">
                    <button type="button" id="btn_cheque_ho_save" class="btn btn-primary">Save</button>
...
<script src="{{Module::asset('cb:js/direct_cheque_collection.js')}}?random=<?php echo uniqid(); ?>"></script>
