    ...
    <div class="card mt-2">
        <div class="card">
            <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Direct Card Bundle List</h5>
            </div>
            <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/cb/direct_card_bundle" class="btn btn-primary">
...
<script src="{{Module::asset('cb:js/direct_card_bundle_list.js')}}?random=<?php echo uniqid(); ?>"></script>
