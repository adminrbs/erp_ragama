            ...
            <div class="card-body border-top">
                ...
                <div class="row mb-3">
                    <div class="col-md-6" style="text-align: right;">
                        ...
                        <button class="btn btn-danger" type="button" style="width: 30%;" id="btnReject">Reject</button>
                        <button class="btn btn-success" type="button" style="width: 30%;" id="btnApproval">Approval</button>
                    </div>
                </div>
            </div>
        </div>
