    ...
    <div class="card mt-2">
        <div class="card">
            <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Cheque Deposit</h5>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="margin-left: 10px;margin-bottom:5px;float:right;">
                    <input type="button" id="btn_deposit_cheque" class="btn btn-primary" value="Save">
                </div>
            </div>
        </div>
    </div>
...
@endsection
@section('scripts')
<script src="{{Module::asset('cb:js/cheque_deposit_list.js')}}?random=<?php echo uniqid(); ?>"></script>
