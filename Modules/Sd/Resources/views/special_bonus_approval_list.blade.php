    ...
    <div class="content">
        <div class="card">
            <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Special Bonus  Approval</h5>
                  ...
                  <div class="row">
                      <div class="col-lg">
                        <input type="hidden" id="bonus_id">
                         <label for="cmb_customer"><i class="fa fa-address-card-o fa-lg text-info " aria-hidden="true">&#160</i>Customer</label>
                          <select id="cmb_customer" class="select2 form-control validate"></select>

                          <label for="fname"><i class="fa fa-address-card-o fa-lg text-info " aria-hidden="true">&#160</i>Item</label>
                          <select id="cmbItem" class="select2 form-control validate"></select>
                          


                          <label for="fname"><i class="fa fa-address-card-o fa-lg text-info " aria-hidden="true">&#160</i>Qty</label>
                        <input type="number" name="txtQty" id="txtQty" class="form-control validate"  autocomplete="off">
                        


                        <label for="fname"><i class="fa fa-address-card-o fa-lg text-info " aria-hidden="true">&#160</i>Free Qty</label>
                        <input type="number" name="txtFreeQty" id="txtFreeQty" class="form-control validate"  autocomplete="off">
                        

                        <label for="fname"><i class="fa fa-address-card-o fa-lg text-info " aria-hidden="true">&#160</i>Valid Days</label>
...
<!-- suply Group -->
<div class="modal fade" id="special_bonus_remark" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content bg-white">
      <div class="modal-header">
      ...
      <div class="modal-body">
              ...
              <div class="modal-body p-4 bg-white">
                  ...
                  <div class="row">
                      <div class="col-lg">
                        <input type="hidden" id="bonus_id">
                         <label for="cmb_customer"><i class="fa fa-address-card-o fa-lg text-info " aria-hidden="true">&#160</i>Remark</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnClose_remark" class="btn btn-secondary">Close</button>
        <button type="button" id="btnsave_remark" class="btn btn-primary ">Reject</button>
...
@section('scripts')
  ...
  <script src="{{ Module::asset('sd:js/special_bonus_approval_list.js') }}?random=<?php echo uniqid(); ?>"></script>
