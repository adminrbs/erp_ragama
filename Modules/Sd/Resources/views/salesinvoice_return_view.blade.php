                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="txtInvoiceID" disabled>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" id="cmbReason"disabled></select>
                                </div>
                                ...
                                <div class="col-md-4" >
                                    ...
                                    <select class="form-select" id="cmbBookNumber" disabled></select>
                                </div>

                                <div class="col-md-4">
                                    <label class="transaction-lbl mb-0 compulsory-field" style="width: 100%;text-align: left;"><span>Page Number</span></label>
                                    <input type="number" id="txtPageNumber" class="form-control" style="text-align:right;" disabled>
                                </div>
                                <!--  <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-striped" id="salesinvoicereturnTable">
                                                <thead>
                                                    <tr>
...
<script src="{{Module::asset('sd:js/salesReturnview.js')}}?random=<?php echo uniqid(); ?>"></script>
