                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="productwisequantitysalestype" id="productwisequantitysalestype" style="margin-right: 10px;" checked>
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
