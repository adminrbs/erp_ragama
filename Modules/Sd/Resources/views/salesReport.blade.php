                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="salesReport" id="salesReport" style="margin-right: 10px;">
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="salesreturnReport" id="salesreturnReport" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                        Sales Return
                                    </label>
                                </li>
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="salesreturndetailsReport" id="salesreturndetailsReport" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                ...
                                <li class="list-group-item" style="display: none;">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="productwisequantitysalestype" id="productwisequantitysalestype" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                        Product wise quantity - sales type
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="salesRepwiseMonthlySummary" id="salesRepwiseMonthlySummary" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                        Sale - Repwise monthly summery
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="itemCustomerReport" id="itemCustomerReport" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="freeSummaryReport" id="freeSummaryReport" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                        Free Summery Report
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="salessummeryreport" id="salessummeryreport" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1" value="debtorleger"
                                            id="debtorleger" style="margin-right: 10px;">
                                        <i class="bi bi-folder2 fa-lg"></i>&nbsp;
                                ...
                                <li class="list-group-item">
                                    <label style="display: flex; align-items: center;">
                                        <input class="form-check-input" type="radio" name="option1"
                                            value="Customer's Outstanding Age Analysis" id="customerOutstanding"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 mb-0 ">
                                                <label style="font-weight: bold;">Marketing Routs</label>
                                                <!--<select class="form-control validate select2" id="cmbRoute"></select>-->
                                                <select multiple="multiple" class="form-select select " id="cmbMarketingRoute" data-placeholder="Select Routs"></select>
                                            </div>
                                            <div class="col-md-1 mt-0">
                                                <input id="chkMarketingRoute" type="checkbox" style="margin-top: 30px;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-11 mb-0 ">
                                                ...
                                                <!--<select class="form-control validate select2" id="cmbRoute"></select>-->
                                                <select multiple="multiple" class="form-select select " id="cmbSupplyGroup" data-placeholder="Select Routs"></select>
...
<script src="{{Module::asset('sd:js/sales_oder_list.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sd:js/salesOrderReport.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sd:js/sales_report.js')}}?random=<?php echo uniqid(); ?>"></script>
