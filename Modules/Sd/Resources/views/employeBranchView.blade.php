...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Assign Employee to Branch</h5>
                        ...
                        <div class="card-header" id="headingDesignation">
                            <h5 class="mb-0">
                                <button class="btn btn-link" data-bs-toggle="collapse" href="#addEmployeeCustomer" role="button" aria-expanded="false" aria-controls="collapseExample" onclick="">
                                    <i class="bi bi-gear" style="margin-right: 5px"></i> Add Employee
                                </button>
                            </h5>
                        </div>
...
<script src="{{Module::asset('sd:js/employe_branch.js')}}?random=<?php echo uniqid(); ?>"></script>
