<div class="modal fade modal-xl" id="SalesReturnInvoiceModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="eSalesReturnInvoiceModal_label">Sales Invoices</h5>
                ...
                <div style="height: 300px;">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="txtInv" id="txtInv" class="form-control">
                            </select>
                        </div>
                    </div>
