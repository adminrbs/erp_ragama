...
<!-- 
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label class="transaction-lbl mb-0" style="width: 100%;text-align: left;"><span>Customer Address Address</span></label>
                                ...
                                <div class="col-md-4" style="display: none;">
                                    ...
                                    <input type="number" id="txtDiscountAmount" class="form-control" disabled>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" id="cmbDeliverType" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- <input type="text" name="date" id="date" class="form-control form-control-sm" required placeholder="Date" autocomplete="off"> -->
                                    <input type="date" class="form-control" id="delivery_date_time" disabled >
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-striped" id="salesorderviewtable">
                                                <thead>
                                                    <tr>
...
<script src="{{Module::asset('sd:js/salesOrderview.js')}}?random=<?php echo uniqid(); ?>"></script>
@endsection