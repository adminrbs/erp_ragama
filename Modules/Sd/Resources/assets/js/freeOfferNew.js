...
$(document).ready(function () {
    ...
    /**Initilization of range table */

    //item table
    tableData = $('#AddrangeTable').transactionTable({
        "columns": [

            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            ...
            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            { "type": "text", "class": "transaction-inputs math-abs", "value": "", "style": "width:85px;text-align:right;", "event": "" },
            { "type": "text", "class": "transaction-inputs", "value": "", "style": "width:100px;", "event": "itemEventListner(this)" },
            { "type": "text", "class": "transaction-inputs", "value": "", "style": "width:130px;text-align:right;", "event": "" },
    ...
    tableData.addRow();
    $('#AddrangeTable').on('input', 'input[type="text"]', function () {
...
function addFreeOffer() {
    ...
    if (start_date <= end_date) {
        ...
        formData.append('cmbApplyTo', applyTo);
...
function addRange(collection) {
    ...
    $('#offerDataTable tr').each(function () {
        ...
        if (checkbox.prop('checked')) {
            ...
            var dataId = $(this).find('td:eq(0) label').data('id');
            selectedIds.push(dataId);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var status = response.status;
            /*   var peimaryKey = response.primaryKey; */
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                dataSource.push([
                    { "type": "text", "class": "transaction-inputs", "value":value.quantity,"data_id": value.free_offer_thresholds_id, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value":value.free_offer_quantity, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.free_offer_value, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.maximum_quantity, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.maximum_value, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.total_offer_quantity, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.total_offer_value, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.Item_code, "style": "width:85px;text-align:right;", "event": "" },
                    { "type": "text", "class": "transaction-inputs", "value": value.item_Name, "style": "width:100px;", "event": "itemEventListner(this)" },
                    { "type": "button", "class": "btn btn-danger", "value": "Remove", "style": "max-height:30px;margin-left:10px;", "event": "removeRow(this)", "width": 30 }
...
function update_thresholdTable(collection){
