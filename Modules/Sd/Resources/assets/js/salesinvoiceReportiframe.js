   ...
   //alert();
    ...
    $.ajax({
        ...
        console.log(data);
            ...
            console.log(headerData[0].is_printed);
            if (report_status == 1) {
           ...
           // htmlContent += '<h2  style="text-align: right; font-size: 16px !important; height: 15px">INVOICE</h2>';
            ...
            htmlContent += '<tr><th ></th><td  colspan="6" style="text-align: left;font-size:20px;">Customer Code :- ' + headerData[0].customer_code + '</td><td colspan="1" style="text-align: left;font-size:18px;"><b>Invoice No :- </b>' + headerData[0].external_number + '</td></tr>';
            htmlContent += '<tr><th ></th><td  colspan="6" style="text-align: left;font-size:20px;">Customer Name :- ' + headerData[0].customer_name + '</td><td colspan="1" style="text-align: left;font-size:18px;"><b>Date :- </b>' + headerData[0].order_date_time + '</td></tr>';
            htmlContent += '<tr><th ></th><td colspan="6" style="text-align: left;font-size:20px;">Customer Address :- ' + headerData[0].primary_address + '</td>';
            ...
            htmlContent += '<td style="text-align: right; width: 110px; border: 1px dotted black;">Price</td>';
          
            htmlContent += '<td style="text-align: right; width: 110px; border: 1px dotted black;">Amount</td>';
            ...
            dt.salesInvoiceReqestItems.forEach(function (item) {
                var retial_price = item.inv_rt_price ? parseFloat(item.inv_rt_price.replace(/,/g, '')) || 0 : 0;
               ...
               // htmlContent += '<tr style="font-size: 16px; font-family: \'Draft\', sans-serif;">';
                ...
                htmlContent += '<td style="text-align: center;  width: 60px;" >' + size || "" + '</td>';
                ...
                htmlContent += '<td style="text-align: right;  width: 110px;">' + formattedPrice + '</td>';
              
                htmlContent += '<td style="text-align: right;  width: 110px;">' + formattedamount + '</td>';
            ...
            Dis_Total = parseFloat(Dis_Total).toFixed(2);
            ...
            htmlContent += '<tr><th colspan="2" style="text-align: left;"></th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: right; font-size:15px;font-family: \'Draft\', sans-serif;">Net Discount</th><th colspan="2" style="text-align: left;"> </th><u><th colspan="3" style="text-align: right; font-size:15px;font-family: \'Draft\', sans-serif;"> ' + parseFloat(Dis_Total).toLocaleString('en-US'); + '</th><u/><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th><th colspan="2" style="text-align: left;"> </th> </th><th colspan="2" style="text-align: left;"> </th><th > </th><th > </th></tr>';
            htmlContent += '<tr>';
...
htmlContent += '</tr>';
            ...
            var htmloutsanding = '';
            var grp_id = undefined;
            if(dt.outstanding[0]){
                 grp_id = dt.outstanding[0].customer_group_id; // avoiding printing outstnading for selected customers
            ...
            if(grp_id != 30){
                ...
                htmloutsanding += '<tr>'
                 ...
                 dt.outstanding.forEach(function (item) {
                    if(item.payment_term == 20){
                        
                        
                        htmloutsanding += '<li style="flex: 0 0 50%; box-sizing: border-box; padding: 0 10px;font-weight: bold;">';
                    }else{
                        console.log(item.payment_term);
                     ...
                     htmloutsanding += item.external_number + "&nbsp&nbsp;"; 
                     if(credit_days <= item.age){
                        htmloutsanding += "<b>"+item.age+"</b>"+ "&nbsp&nbsp;";
                    }else{
                        htmloutsanding += item.age + "&nbsp&nbsp;";
                    }
            ...
            var headerDate = '<table style="width: 100%; text-align: center; border: 0;font-size:20px;"><tr><td colspan="4" style="border: 0;">Printed On ' + headerData[0].current_date_time + '</td></tr></table>';

            var combinedContent = headerDate + htmlContent + htmloutsanding + htmlpayment + footerContent;
