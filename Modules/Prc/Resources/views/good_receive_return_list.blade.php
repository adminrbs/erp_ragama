...
<div class="content">
    ...
    <div class="card mt-2">
        ...
        <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
            <h5 class="mb-0">Goods Return List</h5>
        </div>
        <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/prc/goodReceiveReturn" class="btn btn-primary">
                    <i class="fa fa-plus">&nbsp;Create New</i>
                </a>
            </div>
        <div class="row">
            <div class="col-md-12">
            <table class="table datatable-button-html5-name table-striped" id="GR_return_table">
                <thead>
                    <tr>  
                        <th>Reference #</th>
                        <th>Date</th>
...
<script src="{{Module::asset('prc:js/good_receive_returnList.js')}}?random=<?php echo uniqid(); ?>"></script>
