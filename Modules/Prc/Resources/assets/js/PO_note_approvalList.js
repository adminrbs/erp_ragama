...
$(document).ready(function(){
    getPendingapprovalsPurchaseOrder();
});
...
function edit(id, status) {
    ...
    url = "/prc/purchaseOrderNote?id=" + id +"&paramS=Original"+"&action=edit"+"&task=null";
    window.location.href = url;
}

function view(id,status){
    url = "/prc/purchaseOrderView?id=" + id +"&paramS=Original"+"&action=view"+"&task=null";
    window.location.href = url;
}

//load data to table
function getPendingapprovalsPurchaseOrder(){
    $.ajax({
        url:'/prc/getPendingapprovalsPurchaseOrder',
        type:'get',
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
