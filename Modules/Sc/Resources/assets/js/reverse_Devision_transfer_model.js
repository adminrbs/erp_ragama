...
$(document).ready(function () {
    ...
    $('#si_model_btn').on('click',function(){
        ...
        get_dispatches_to_reverse_devision_model($('#cmb_to_Branch').val(),$('#cmb_to_Location').val());
    });
    ...
    $('#gettable tbody').on('click', 'tr', function() {
        ...
        $(this).addClass('selected');
         ...
         get_dispatch_items_to_reverse(dispatchId);
      });

      $('#bntLoadData').on('click',function(){
        load_dispatch_items_for_reverse(dispatchId);
      });
      
});

//load dispatches to model table
function get_dispatches_to_reverse_devision_model(branch_id,location_id){
   // alert();
    $.ajax({
        url: '/sc/get_dispatches_to_reverse_devision_model/'+branch_id+'/'+location_id,
        type: 'get',
        async: false,
...
function get_dispatch_items_to_reverse(id) {
    ...
    $.ajax({
        type: "GET",
        url: "/sc/get_dispatch_items_to_reverse/" + id,
        cache: false,
        timeout: 800000,
        async:false,
        beforeSend: function () { },
...
function load_dispatch_items_for_reverse(id){
    ...
    $.ajax({
        type: "get",
        url: "/sc/load_dispatch_items_for_reverse/"+ id,
