...
<script src="{{Module::asset('sc:js/sample_dispatch.js')}}?random=<?php echo uniqid(); ?>"></script>

<script src="{{Module::asset('sc:js/sample_disptach_setoff_model.js')}}?random=<?php echo uniqid(); ?>"></script>
