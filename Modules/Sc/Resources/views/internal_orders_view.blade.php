                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-striped" id="item_tbl">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Name</th>
                                                        <th>Pack Size</th>
                                                        <th>Request By B.Stock</th>
                                                        <th>Request From B.Stock</th>
                                                        <th>AVG Sales</th>
                                                        <th>Re-order</th>
                                                        <th>QTY</th>
...
<script src="{{Module::asset('sc:js/internal_orders_view.js')}}?random=<?php echo uniqid(); ?>"></script>
