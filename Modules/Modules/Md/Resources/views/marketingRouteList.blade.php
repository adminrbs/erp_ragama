    ...
    <div class="card mt-2">
        <div class="card">
            <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Marketing Delivery Routes</h5>
            </div>
...
<!-- /content area -->
@include('md::marketingRouteModel')
...
<script src="{{Module::asset('md:js/MarketingrouteList.js')}}?random=<?php echo uniqid(); ?>"></script>
