            ...
            <div class="card">
                ...
                <div class="card card-body">
                    ...
                    <ul class="nav nav-tabs mb-0" id="tabs">
                        ...
                        <li class="nav-item rbs-nav-item" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="mb-1">
                                                ...
                                                <div>
                                                    <input class="form-control form-control-sm validate" type="number" id="txtAlertcreaditamountlimit" name="numbers">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div>
                                                    <select class="form-select form-control-sm validate" id="cmbCustomerStatus" name="customerstatus">
                                                ...
                                                <label class="col-form-label mb-0"><i class="fa fa-address-card-o fa-lg text-info" aria-hidden="true">&#160</i>Payment Term</label>

                                                <div>
                                                    <select class="form-select form-control-sm validate" id="cmbPaymentTerm" name="cmbPaymentTerm">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <label class="col-form-label mb-0"><i class="fa fa-address-card-o fa-lg text-info" aria-hidden="true">&#160</i>Credit control by type </label>

                                                <div>
                                                    <select class="form-select form-control-sm validate" id="cmbCreditcontrolbytype" name="Creditcontrolbytype">
                                                        <option value="1">Primary credit control</option>
                                                        <option value="2">Branch wise credit control</option>
                                                        <option value="3">Sales Rep wise credit control</option>
                                                        <option value="4">Product group wise credit control</option>
                                                        <option value="5">Supply group wise credit control</option>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <label class="col-form-label mb-0"><i class="fa fa-address-card-o fa-lg text-info" aria-hidden="true">&#160</i>Free offer </label>

                                                <div>
                                                    <select class="form-select form-control-sm validate" id="cmbFreeOffer" name="cmbFreeOffer">
                                                        <option value="0">Free Offer Not Allowed</option>
                                                        <option value="1">Normal Free Offer</option>
                                                        <option value="2">Customer Wise Free Offer</option>
                                                        <option value="3">Special Free Offer</option>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <label class="col-form-label mb-0"><i class="fa fa-address-card-o fa-lg text-info" aria-hidden="true">&#160</i>Deliver to primary addess</label>
                                                <div>
                                                    <label class="form-check form-switch">
                                                        <input type="checkbox" class="form-check-input" name="switch_single" id="chkDelivertoprimaryaddess">
                                                        <span class="form-check-label"></span>
                                                    </label>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <!-- <label class="col-form-label mb-0"><i class="fa fa-address-card-o fa-lg text-info" aria-hidden="true">&160</i>Free offer allowd</label>
                                                <div>
                                                    <label class="form-check form-switch">
                                                        <input type="checkbox" class="form-check-input" name="switch_single" id="chkFreeofferAllowed">
                                                        <span class="form-check-label"></span>
                                                    </label>

                                                </div> -->
                                                <label class="col-form-label mb-0"><i class="fa fa-address-card-o fa-lg text-info" aria-hidden="true">&#160</i>Prmotion allowd</label>
                                                <div>
                                                    <label class="form-check form-switch">
                                                        <input type="checkbox" class="form-check-input" name="switch_single" id="chkPromotionAllowed">
                                                        <span class="form-check-label"></span>
                                                    </label>
