                                    ...
                                    <table class="table table-sm table-striped" id="tblData">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Price</th>
                                                <th>Batch</th>
                                                <th>From Loc RD Sale</th>
                                                <th>To Loc RD Sale</th>
                                                <th>From Loc QOH</th>
                                                <th>To Loc QOH</th>
...
@include('sc::dispatch_to_branch_setoff_modal')
@include('sc::devisionTransferModel')
...
<script src="{{Module::asset('sc:js/dispatch_to_branch.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sc:js/dispatch_to_branch_model.js')}}?random=<?php echo uniqid(); ?>"></script>
@endsection