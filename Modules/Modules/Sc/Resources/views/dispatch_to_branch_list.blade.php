...
<div class="content">
    ...
    <div class="card mt-2">
        ...
        <div class="row">
            <div class="col-md-12">
            <table class="table datatable-fixed-both table-striped" id="dispatch_to_branch_list">
                <thead>
                    <tr>  
                        <th>Date</th>
                        <th>Reference #</th>
...
<script src="{{Module::asset('sc:js/dispatch_to_branch_list.js')}}?random=<?php echo uniqid(); ?>"></script>
