...
<div class="content">
    ...
    <div class="card mt-2">
        ...
        <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
            <h5 class="mb-0">Reverse Transfer</h5>
        </div>
        <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/sc/reverse_devision_transfer" class="btn btn-primary">
        ...
        <div class="row">
            <div class="col-md-12">
            <table class="table datatable-fixed-both table-striped" id="reverse_transfer_list_table">
                <thead>
                    <tr>  
                        <th>Date</th>
                        <th>Reference #</th>
...
<script src="{{Module::asset('sc:js/reverse_division_transfer_list.js')}}?random=<?php echo uniqid(); ?>"></script>
