        ...
        <div class="col-xl-12 mt-2">
            <div class="card">
                <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                    <h5 class="mb-0">Reverse Division Transfer</h5>
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="col-12">
                            <div class="row" style="margin-left: 50px;">
                                <div class="alert alert-primary alert-icon-start alert-dismissible text-truncate rounded-pill fade show col-md-10" id="div_info">
                                    <span class="alert-icon bg-primary text-white rounded-pill" style="font-size: 20px;">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                    Please select <span class="fw-semibold">branch</span> before pick a dispatched stock!
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-4">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="transaction-lbl mb-0 compulsory-field info" style="width: 100%;text-align: left;"><span>To Branch</span></label>
                                            <select class="form-select" id="cmb_to_Branch"></select>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="transaction-lbl mb-0 compulsory-field info" style="width: 100%;text-align: left;"><span>To Location</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped" id="dispatch_receive_item">
                                        <thead>
                                            <tr>
...
@include('sc::reverse_devision_transfer_model')
...
<script src="{{Module::asset('sc:js/reverse_devision_transfer.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sc:js/reverse_Devision_transfer_model.js')}}?random=<?php echo uniqid(); ?>"></script>
@endsection