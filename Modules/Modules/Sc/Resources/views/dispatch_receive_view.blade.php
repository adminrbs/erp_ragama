                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped" id="dispatch_receive_view_item">
                                        <thead>
                                            <tr>
...
<script src="{{Module::asset('sc:js/dispatch_receive_view.js')}}?random=<?php echo uniqid(); ?>"></script>
