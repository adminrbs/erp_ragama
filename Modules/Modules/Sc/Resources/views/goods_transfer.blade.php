...
<script src="{{Module::asset('sc:js/goods_trasnfer.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sc:js/goods_transfer_model.js')}}?random=<?php echo uniqid(); ?>"></script>
@endsection