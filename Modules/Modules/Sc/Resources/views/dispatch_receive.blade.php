                        ...
                        <div class="col-12">
                            <div class="row" style="margin-left: 50px;">
                                <div class="alert alert-primary alert-icon-start alert-dismissible text-truncate rounded-pill fade show col-md-10">
                                    ...
                                    Please select <span class="fw-semibold">To branch</span> before pick a received stock!
...
<script src="{{Module::asset('sc:js/dispatch_receive.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sc:js/dispatch_recieve_model.js')}}?random=<?php echo uniqid(); ?>"></script>
@endsection