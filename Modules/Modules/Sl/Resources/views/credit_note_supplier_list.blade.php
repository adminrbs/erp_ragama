...
<div class="content">
    ...
    <div class="card mt-2">
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table datatable-fixed-both table-striped" id="credit_note_list">
                        <thead>
                            <tr>
                                <th>Reference</th>
                                <th>Date</th>
...
<script src="{{Module::asset('sl:js/credit_note_supplier_list.js')}}?random=<?php echo uniqid(); ?>"></script>
