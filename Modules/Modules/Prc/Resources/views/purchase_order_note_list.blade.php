...
<div class="content">
    ...
    <div class="card mt-2">
        ...
        <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/prc/purchaseOrderNote" class="btn btn-primary">
        ...
        <div class="row">
            <div class="col-md-12">
            <table class="table datatable-fixed-both table-striped" id="purchase_order_table">
                <thead>
                    <tr>  
                        <th>Reference #</th>
                        <th>Date</th>
...
<script src="{{Module::asset('prc:js/purchase_order_list.js')}}?random=<?php echo uniqid(); ?>"></script>
