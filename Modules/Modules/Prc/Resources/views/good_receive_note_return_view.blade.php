                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="lblSupplierAddress" disabled></label>
                                </div>
                                <!-- <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped" id="goodreturnviewtable">
                                        <thead>
                                            <tr>
...
<script src="{{Module::asset('prc:js/good_receive_return_view.js')}}?random=<?php echo uniqid(); ?>"></script>
