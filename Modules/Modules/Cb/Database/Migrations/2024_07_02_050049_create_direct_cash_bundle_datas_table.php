...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('direct_cash_bundle_datas', function (Blueprint $table) {
            $table->id('direct_cash_bundle_data_id');
            $table->integer('direct_cash_bundles')->index();
    ...
    {
        Schema::dropIfExists('direct_cash_bundle_datas');
    }
};
