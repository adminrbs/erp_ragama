        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table datatable-fixed-both table-striped" id="cash_collection_by_branch_table" style="table-layout:fixed">
                        <thead>
                            <tr>
                                <th>Reference #</th>
                                <th>Date</th>
...
<script src="{{Module::asset('cb:js/cash_collection_by_branch.js')}}?random=<?php echo uniqid(); ?>"></script>
