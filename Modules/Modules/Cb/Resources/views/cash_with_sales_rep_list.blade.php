          ...
          <!--   <div class="col-md-3" style="margin-left: 10px;margin-top: 10px">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table datatable-fixed-both table-striped" id="cash_with_sales_rep_table">
                        <thead>
                            <tr>
                                <th>Sales Rep</th>
...
<!--Model -->
<div class="modal fade modal-xl" id="cash_with_Sales_rep_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="card card-body">
                    ...
                    <ul class="nav nav-tabs mb-0" id="tabs">
                        <li class="nav-item rbs-nav-item">
                            <a href="#total_cash" class="nav-link active" aria-selected="true">Cash In Hand</a>
                        </li>
                        <li class="nav-item rbs-nav-item">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-4">
                                            <div class="table-responsive">
                                                <div class="table-container">
                                                <table id="total_Cash_table" class="table">
                                                    <thead>
                                                        <tr>
                                                            <th>Reference</th>
                                                            <th>Receipt Date</th>
                            ...
                            <div class="tab-pane fade show" id="late">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-4">
                                            <div class="table-responsive">
                                                <table id="late_Cash_table" class="table">
                                                    <thead>
                                                        <tr>
                                                            <th>Reference</th>
                                                            <th>Receipt Date</th>
...
@endsection
@section('scripts')
<script src="{{Module::asset('cb:js/cash_with_sales_rep_list.js')}}?random=<?php echo uniqid(); ?>"></script>
