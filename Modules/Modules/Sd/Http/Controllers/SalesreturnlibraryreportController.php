...
class SalesreturnlibraryreportController extends Controller
{
    public function salesreturnReport($search)
    {
        try {
           ...
           // $selectItem = $searchOption[10]->cmbProduct;
            ...
            if ($nonNullCount > 1) {
              ...
              INNER JOIN branches D ON D.branch_id = SR.branch_id
";
            ...
            if ($searchOption !== null) {
                ...
                if ($nonNullCount > 1) {
                    ...
                    if (!empty($filterLabel)) {
                        ...
                        $reportViwer->addParameter("sub_title", "Sales Return ".$filterLabel);
                    }
            ...
            return $reportViwer->viewReport('salesreturnRport.json');
        } catch (Exception $ex) {
            return $ex;
        }
    }
