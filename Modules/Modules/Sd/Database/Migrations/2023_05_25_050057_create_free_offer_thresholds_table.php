...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('free_offer_thresholds', function (Blueprint $table) {
            $table->id('free_offer_thresholds_id');
            ...
            $table->index('free_offer_thresholds_id','fr_offer_threshoId');
        });
    }
    ...
    {
        Schema::dropIfExists('free_offer_thresholds');
    }
};
