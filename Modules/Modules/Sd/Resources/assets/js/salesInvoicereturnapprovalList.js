...
function edit(id, status) {
    ...
    url = "/sd/salesReturn?id=" + id +"&paramS=Original"+"&action=edit"+"&task=null";
    window.open(url, "_blank");

}

function view(id,status){
    url = "/sd/salesReturn?id=" + id +"&paramS=Original"+"&action=view"+"&task=null";
    window.open(url, "_blank");
}
...
function getPendingapprovals(){
    $.ajax({
        url:'/sd/getPendingapprovalsSalesInvReturn',
        type:'get',
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
