        ...
        <div class="col-xl-12 mt-2">
            <div class="card">
                <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                    <h5 class="mb-0">Assign Route to Sales Reps</h5>
                            ...
                            <div class="card-header" id="headingDesignation">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" data-bs-toggle="collapse" href="#addCustomerLocation" role="button" aria-expanded="false" aria-controls="collapseExample" onclick="">
                                        <i class="bi bi-gear" style="margin-right: 5px"></i>Select Routes
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="headingDesignation">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" data-bs-toggle="collapse" href="#copyrouts" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="bi bi-gear" style="margin-right: 5px"></i> Copy Routes Another Sales Rep
                                    </button>
                                </h5>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="customerlocationList" class="collapse" aria-labelledby="headingDesignation" data-parent="#accordionExample">
                                <div class="card-body">
                                    ...
                                    <table id="route_salesrep" class="datatable-fixed-both table table-striped">
                                        <thead>
                                            <tr>
                                                <th>Select</th>
                                                <th>Route</th>
...
<script src="{{ Module::asset('sd:js/assingrouttosalesrep.js') }}?random=<?php echo uniqid(); ?>"></script>
