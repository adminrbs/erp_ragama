                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form id="frmOfferData">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select class="form-control" id="cmbRedeemas">
                                                    ...
                                                    <button type="button" class="btn btn-primary" id="saveBTNofferData">Add</button>
                                                    <button type="button" class="btn btn-danger" id="deleteBTNofferData">Remove</button>
                                        ...
                                        <div class="card" id="threshold_colap">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <br>
                                                <button class="btn btn-primary" id="btnThreshold">Add</button>
                                            </div>
                                        ...
                                        <div class="card" id="range_colap">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <br>
                                                <button class="btn btn-primary" id="btnSaveRange">Add</button>
...
<script src="{{Module::asset('sd:js/freeOfferNew.js')}}?random=<?php echo uniqid(); ?>"></script>
<script src="{{Module::asset('sd:js/freeOfferApplyNewTo.js')}}?random=<?php echo uniqid(); ?>"></script>
