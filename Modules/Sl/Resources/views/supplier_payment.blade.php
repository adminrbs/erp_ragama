        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                    <h5 class="mb-0">Supplier Payment</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="compulsory-field">Supplier Code</label>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="max-width: 80px;text-align: right;" class="">Return Amount</th>
...
<script src="{{Module::asset('sl:js/supplier_payment.js') }}?random=<?php echo uniqid(); ?>"></script>
