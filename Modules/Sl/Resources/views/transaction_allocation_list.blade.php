    ...
    <div class="card mt-2">
        <div class="card">
            ...
            <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/sl/supplier_transaction_allocation" class="btn btn-primary">
...
<!-- /content area -->
@include('sl::transaction_allocation_view_model');
@endsection
...
<script src="{{Module::asset('sl:js/transaction_allocation_list.js')}}?random=<?php echo uniqid(); ?>"></script>
