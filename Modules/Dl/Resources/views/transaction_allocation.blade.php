        ...
        <div class="col-xl-12 mt-2">
            <div class="card">
                <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                    <h5 class="mb-0">Transaction Allocation</h5>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-3">
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <label class="transaction-lbl" style="width: 100%;text-align: left;"><span>Customer</span></label>
                                                                        </div>
                                                                        <div class="col-7"><input type="text" id="txt_customer" class="form-control" style="text-align:left;" placeholder="Search Customer"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-3">
                                                                    <div class="row">
...
<script src="{{Module::asset('dl:js/transaction_allocation.js')}}?random=<?php echo uniqid(); ?>"></script>
