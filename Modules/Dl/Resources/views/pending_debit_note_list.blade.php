    ...
    <div class="card mt-2">
        <div class="card">
            <div class="card-header bg-dark text d-flex align-items-center" style="color: white;">
                <h5 class="mb-0">Debit Note Pending List</h5>
            </div>
          <!--   <div class="col-md-3" style="margin-left: 10px;margin-top:5px">
                <a href="/dl/debit_note" class="btn btn-primary">
...
<script src="{{Module::asset('dl:js/pending_debit_note_list.js')}}?random=<?php echo uniqid(); ?>"></script>
