...
$(document).ready(function () {
    (function ($) {
        table = $.fn.transactionTable = function (property) {
            ...
            this.appendRow = function (row,row_id) {
                ...
                if (row_id != undefined) {
                    $('#' + table_id + ' > tbody > tr').eq(row_id).after(row_column);
                }else{
            ...
            this.addRow = function () {
                ...
                this.appendRow(COLUMNS,undefined);
            ...
            this.insertRow = function (row_id) {
                var objects = this.getDataSourceObject();
                var tr = $(objects[objects.length - 1]);
                for (var i = 0; i < tr.length; i++) {
            ...
            this.setDataSource = function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    this.appendRow(data[i],undefined);
                }
