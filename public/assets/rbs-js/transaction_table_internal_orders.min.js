            ...
            this.appendRow = function (row) {
                ...
                for (var i = 0; i < row.length; i++) {
                    ...
                    if (row[i].type == 'text') {
                        ...
                        if (row[i].compulsory) {
                            row_column += '<td style="max-width:' + width + ';padding-left:0px;padding-right:0px;"><input name="' + name + '" type="text" class="' + class_name + '" value="' + value + '" style="' + style + '" onfocus="' + event + ';selectedColumn(' + COLUMN_ID + ');" onclick="' + event + ';showTransactionDataChooserEventListener(this);" oninput="' + event + ';thousand_separator(this,' + thousand_seperator + ');dataid_clear(this);" data-id ="' + row[i].data_id + '" ' + row[i].disabled + ' compulsory="true" value-from="' + valuefrom + '"></td>';
                        } else {
                    ...
                    if (row[i].type == 'number') {
                        ...
                        if (row[i].compulsory) {
                            row_column += '<td style="max-width:' + width + ';padding-left:0px;padding-right:0px;"><input name="' + name + '" type="number" class="' + class_name + '" value="' + value + '" style="' + style + '" onfocus="' + event + ';selectedColumn(' + COLUMN_ID + ');" onclick="' + event + ';showTransactionDataChooserEventListener(this);" oninput="' + event + ';thousand_separator(this,' + thousand_seperator + ');dataid_clear(this);" data-id ="' + row[i].data_id + '" ' + row[i].disabled + ' compulsory="true" value-from="' + valuefrom + '"></td>';
                        } else {
                            row_column += '<td style="max-width:' + width + ';padding-left:0px;padding-right:0px;"><input name="' + name + '" type="number" class="' + class_name + '" value="' + value + '" style="' + style + '" onfocus="' + event + ';selectedColumn(' + COLUMN_ID + ');" onclick="' + event + ';showTransactionDataChooserEventListener(this);" oninput="' + event + ';thousand_separator(this,' + thousand_seperator + ');dataid_clear(this);" data-id ="' + row[i].data_id + '" ' + row[i].disabled + ' value-from="' + valuefrom + '"></td>';
                        }
                        COLUMN_ID++;
...
function setSelectedRow() {
    ...
    document.body.onkeydown = function (e) {
        ...
        if (e.keyCode == 38 || e.keyCode == 40) {
            console.log(SELECTED_COLUMN_ID);
            var cells = $(rows[selectedRow]).find('td');
            cells.each(function (index) {
                if (index == SELECTED_COLUMN_ID) {
