...
$(document).ready(function(){
    ...
    $('#cmbBranch').on('change',function(){
        ...
        load_audited_cheque(global_branch_id_,global_collector_id);
...
function load_audited_cheque(br_id,collector_id_){
    ...
    $.ajax({
            url:'/cb/load_audited_cheque/'+br_id+'/'+collector_id_,
            type:'get',
            cache: false,
            timeout: 800000,
            beforeSend: function () { },
