...
$(document).ready(function () {
    ...
    tableData.addRow();
    /*   $('.batchBtn').html('<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">99+<span class="visually-hidden">unread messages</span>'); */
            ...
            callback: function (result) {
                ...
                if (result) {
                    if ($('#btnSave').text() == 'Save and Send') {
                        newReferanceID('sales_invoices', '210');
                        addSalesInvoice(collection, Invoice_id);
...
//add SI
function addSalesInvoice(collection, id) {
