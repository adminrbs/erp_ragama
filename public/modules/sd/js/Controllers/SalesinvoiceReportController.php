...
class SalesinvoiceReportController extends Controller
{
    ...
    public function printsalesinvoicePddf($id, $status)
    {
        ...
        try {
            ...
            $outstanding_qry = DB::select('SELECT DL.trans_date, 
    DL.external_number, 
...
WHERE 
    ...
    WHERE
       ...
       // dd($result);
        $salesIinvoice = sales_Invoice::find($id);
        $salesIinvoice->is_printed = 1;
        $salesIinvoice->update();
        return $result;
    }
