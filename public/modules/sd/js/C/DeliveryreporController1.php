...

{
    public function delivery_report($id)
    {
        ...
        try {
            ...
            $quary = "SELECT T.town_id,T.townName,H.manual_number AS Invoice_number , C.customer_name,employees.employee_name,H.total_amount
            ...
            INNER JOIN delivery_plan_town_lists DPT ON DPT.delivery_plan_id=DP.delivery_plan_id
            INNER JOIN town_non_administratives  T ON T.town_id=DPT.town_id 
