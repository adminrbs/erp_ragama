...
function getFilteredData(id) {
    ...
    $.ajax({
        url: '/sd/getCustomerDataTOlistbox/' + id,
        method: 'post',
...
function getselectemployee(){
   ...
   // alert(selectedBranchId)
    ...
    $.ajax({
        url: '/sd/getselectemployee/'+ selectedemployeeId,
        method: 'get',
        async: false,
        datatype: 'json',
        success: function (data) {
...
function getEmployeeCustomerDetails() {
    ...
    $.ajax({
        type: "GET",
        url: "/sd/getEmployeeCustomerDetails",
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
        success: function (response) {
...
function getRoutes(){
    ...
    var itm_name = "Select"
    $.ajax({
        url: '/sd/getDeliveryRoutesTofilter/',
        method: 'GET',
        async: false,
        datatype: 'json',
        success: function (data) {
