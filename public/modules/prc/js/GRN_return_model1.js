...
function autoSetOff(item_id) {
    ...
    for (var i3 = 0; i3 < array.length; i3++) {
        ...
        row += '<td style="width:50px;"><input type="number" style="text-align:right;" class="transaction-inputs" value="" oninput="validate_total(this)"  onkeyup="allowOnlyNumbers(this)"></td>';
        row += '<td style="width:50px;"><input type="number" style="text-align:right;" class="transaction-inputs" value="" oninput="validate_total(this)" onkeyup="allowOnlyNumbers(this)"></td>';
        row += '<td><input type="checkbox" class="form-check-input" onChange="set_off_qty_foc(this)"></td>'
        row += '</tr>'
...
//set of automatically without model
function set_off_automatically_with_model(collection) {
    console.log(collection);
