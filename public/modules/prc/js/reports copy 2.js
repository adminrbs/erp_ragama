...
function showPoHelpReport(result, flag) {
    ...
    for (var supplyGroupId in groupedData) {
        if (groupedData.hasOwnProperty(supplyGroupId)) {
            ...
            processGroupData(supplyGroupId, groupDataArray);
        }
    }
    ...
    function processGroupData(supplyGroupId, data_array) {
...
function showPoHelpReportBody(result) {
    ...
    for (i = 0; i < result.length; i++) {
      ...
      /*   var groupedData = {}; */
        ...
        // Iterate through the 'data' array in the JSON object
        /* $.each(result[i], function (index, element) {

           
            var supplyGroupId = element.supply_group_id;
            console.log(supplyGroupId);
