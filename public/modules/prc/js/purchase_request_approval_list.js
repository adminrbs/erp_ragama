...
function Approval(id){
        ...
        url = "/prc/purchaseRequest?id=" + id +"&paramS=Original"+"&action=edit"+"&task=approval";
...
function edit(id, status) {
    ...
    url = "/prc/purchaseRequest?id=" + id +"&paramS=Original"+"&action=edit"+"&task=null";
    window.location.href = url;

}

function view(id,status){
    url = "/prc/purchaseRequest?id=" + id +"&paramS=Original"+"&action=view"+"&task=null";
    window.location.href = url;
}
