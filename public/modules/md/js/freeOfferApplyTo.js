...
function getAllOfferCustomerSData(id){
    $.ajax({
        type: "GET",
        url: "/md/getAllOfferCustomerSData/"+id,
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
        success: function (response) {
...
function deleteofferCustomer(){
    ...
    $.ajax({
        url: '/md/deleteofferCustomer', // Replace with your Laravel route URL
        type: 'DELETE',
          headers: {
...
function getAllOfferLocationData(id){
    $.ajax({
        type: "GET",
        url: "/md/getAllOfferLocationData/"+id,
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
        success: function (response) {
...
function deleteOfferLocation(){
    ...
    $.ajax({
        url: '/md/deleteOfferLocation', // Replace with your Laravel route URL
        type: 'DELETE',
          headers: {
            'X-CSRF-TOKEN': token // Include the CSRF token in the headers
        },
...
function getAllCustomerGradeOfferData(id){
    $.ajax({
        type: "GET",
        url: "/md/getAllCustomerGradeOfferData/"+id,
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
        success: function (response) {
...
function deleteOfferCustomerGrade(){
    ...
    $.ajax({
        url: '/md/deleteOfferCusGrade', // Replace with your Laravel route URL
        type: 'DELETE',
          headers: {
            'X-CSRF-TOKEN': token // Include the CSRF token in the headers
        },
...
function getAllCustomerGroupOfferData(id){
    $.ajax({
        type: "GET",
        url: "/md/getAllCustomerGroupOfferData/"+id,
        cache: false,
        timeout: 800000,
        beforeSend: function () { },
        success: function (response) {
...
function DeleteOfferCusGroup(){
    ...
    $.ajax({
        url: '/md/DeleteOfferCusGroup', // Replace with your Laravel route URL
        type: 'DELETE',
          headers: {
            'X-CSRF-TOKEN': token // Include the CSRF token in the headers
        },
