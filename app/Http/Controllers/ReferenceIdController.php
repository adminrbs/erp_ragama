...
LIMIT 1";  */
    ...
    public function newReferenceNumber_direct_bank_slip_bundles(Request $request,$table, $doc_number){
        try {
            ...
            $query = "SELECT IF(ISNULL(external_number),0,external_number) AS id FROM " . $table . "  WHERE document_number = '" . $doc_number . "' AND external_number LIKE '%" . $prefix . "%' AND branch_id = '" . $branch_id . "'  ORDER BY direct_slip_bundles_id DESC LIMIT 1";
            // dd($query);
            $result = DB::select($query);
